...
class NewDatabaseUserInput(BaseModel):
    """
    ...
    database_db_ids: Optional[List[StrictInt]] = Field(default=None, alias="databaseDbIds")
    __properties: ClassVar[List[str]] = ["databaseId", "name", "password", "hostname", "databaseDbIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "databaseDbIds": obj.get("databaseDbIds")
        })
        return _obj
