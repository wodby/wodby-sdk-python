...
class OrgCapabilities(BaseModel):
    ...
    OrgCapabilities
    """ # noqa: E501
    custom_domains: StrictBool = Field(alias="customDomains")
    auto_backups: StrictBool = Field(alias="autoBackups")
    users: StrictBool
    projects: StrictBool
    cron_schedules: StrictBool = Field(alias="cronSchedules")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "autoBackups": obj.get("autoBackups"),
            "users": obj.get("users"),
            "projects": obj.get("projects"),
            "cronSchedules": obj.get("cronSchedules"),
