...
class Domain(object):
    ...
    def __init__(self, id=None, name=None, org_id=None, instance_id=None, enabled=None, primary=None, protected=None, indexed=None, ssl=None, ssl_required=None, ssl_custom=None, hsts=None, hsts_subdomains=None, redirect_to_www=None, redirect_to_non_www=None, status=None, type=None, created=None, updated=None):  # noqa: E501
