...
class NewImportInput(BaseModel):
    """
    NewImportInput
    """ # noqa: E501
    ...
    var_import: ImportInput = Field(alias="import")
    __properties: ClassVar[List[str]] = ["appServiceID", "databaseDBID", "import"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "import": ImportInput.from_dict(obj["import"]) if obj.get("import") is not None else None
        })
        return _obj
