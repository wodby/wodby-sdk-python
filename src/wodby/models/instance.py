...
class Instance(object):
    ...
    def __init__(self, id=None, name=None, title=None, type=None, org_id=None, app_id=None, server_id=None, stack_rev_number=None, stack_version=None, stack_id=None, git_repo_id=None, git_repo_target=None, has_new_version=None, status=None, created=None, updated=None, last_deploy=None):  # noqa: E501
