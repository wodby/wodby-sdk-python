...
class Instance(object):
    ...
    def __init__(self, app_id=None, created=None, git_repo_id=None, git_repo_target=None, has_new_version=None, id=None, name=None, org_id=None, server_id=None, stack_id=None, stack_rev_id=None, status=None, title=None, type=None, updated=None):  # noqa: E501
        ...
        self.stack_rev_id = stack_rev_id
        self.status = status
        self.title = title
        if type is not None:
            self.type = type
    ...
    @property
    def stack_rev_id(self):
        """Gets the stack_rev_id of this Instance.  # noqa: E501


        :return: The stack_rev_id of this Instance.  # noqa: E501
        :rtype: str
        """
        return self._stack_rev_id

    @stack_rev_id.setter
    def stack_rev_id(self, stack_rev_id):
        """Sets the stack_rev_id of this Instance.


        :param stack_rev_id: The stack_rev_id of this Instance.  # noqa: E501
        :type: str
        """
        if stack_rev_id is None:
            raise ValueError("Invalid value for `stack_rev_id`, must not be `None`")  # noqa: E501

        self._stack_rev_id = stack_rev_id
