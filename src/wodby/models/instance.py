...
class Instance(object):
    ...
    def __init__(self, app_id=None, created=None, git_repo_id=None, git_repo_target=None, has_new_version=None, id=None, last_deploy=None, name=None, org_id=None, server_id=None, stack_id=None, stack_rev_number=None, status=None, title=None, type=None, updated=None):  # noqa: E501
