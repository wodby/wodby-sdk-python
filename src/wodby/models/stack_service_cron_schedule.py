...
class StackServiceCronSchedule(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "stackServiceId", "name", "title", "crontab", "command", "workload", "disabled", "envType", "createdAt", "updatedAt"]
