...
class ModelImport(BaseModel):
    ...
    app_service_deployment_id: Optional[StrictInt] = Field(default=None, alias="appServiceDeploymentId")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if app_service_deployment_id (nullable) is None
        # and model_fields_set contains the field
        if self.app_service_deployment_id is None and "app_service_deployment_id" in self.model_fields_set:
            _dict['appServiceDeploymentId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "appServiceDeploymentId": obj.get("appServiceDeploymentId"),
