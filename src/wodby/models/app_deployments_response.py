...
class AppDeploymentsResponse(BaseModel):
    """
    AppDeploymentsResponse
    """ # noqa: E501
    items: List[AppDeployment]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [AppDeployment.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
