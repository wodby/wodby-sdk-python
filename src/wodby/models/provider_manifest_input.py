...
class ProviderManifestInput(BaseModel):
    """
    ...
    manifest_yaml: StrictStr = Field(description="Complete variable provider manifest YAML.", alias="manifestYaml")
    __properties: ClassVar[List[str]] = ["orgId", "projectId", "manifestYaml"]
