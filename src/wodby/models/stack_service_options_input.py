...
class StackServiceOptionsInput(BaseModel):
    """
    StackServiceOptionsInput
    """ # noqa: E501
    options: List[StackServiceOptionInput]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "options": [StackServiceOptionInput.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
