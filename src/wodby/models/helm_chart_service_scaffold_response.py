...
class HelmChartServiceScaffoldResponse(BaseModel):
    """
    HelmChartServiceScaffoldResponse
    """ # noqa: E501
    analysis: HelmChartAnalysis
    manifest_yaml: StrictStr = Field(alias="manifestYaml")
    manifest: Dict[str, Any]
    warnings: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["analysis", "manifestYaml", "manifest", "warnings"]
