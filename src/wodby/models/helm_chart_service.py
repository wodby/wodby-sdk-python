...
class HelmChartService(BaseModel):
    """
    HelmChartService
    """ # noqa: E501
    name: StrictStr
    ...
    ports: Optional[List[HelmChartServicePort]] = None
    headless: StrictBool
    __properties: ClassVar[List[str]] = ["name", "labels", "selector", "ports", "headless"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ports": [HelmChartServicePort.from_dict(_item) for _item in obj["ports"]] if obj.get("ports") is not None else None,
