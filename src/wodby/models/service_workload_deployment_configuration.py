...
class ServiceWorkloadDeploymentConfiguration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "kind", "override", "effective"]

    @field_validator('kind')
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['deployment', 'statefulset', 'daemonset']):
            raise ValueError("must be one of enum values ('deployment', 'statefulset', 'daemonset')")
        return value
