...
class GitAutoUpdateSettingsInput(BaseModel):
    """
    GitAutoUpdateSettingsInput
    """ # noqa: E501
    enabled: StrictBool
    branches: StrictBool
    semver_tags: StrictBool = Field(alias="semverTags")
    ...
    __properties: ClassVar[List[str]] = ["enabled", "branches", "semverTags", "allowPatch", "allowMinor", "allowMajor"]
