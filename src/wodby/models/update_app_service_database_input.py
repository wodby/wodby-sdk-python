...
class UpdateAppServiceDatabaseInput(BaseModel):
    """
    UpdateAppServiceDatabaseInput
    """ # noqa: E501
    database_db_id: Optional[StrictInt] = Field(default=None, alias="databaseDbId")
    database_user_id: Optional[StrictInt] = Field(default=None, alias="databaseUserId")
    __properties: ClassVar[List[str]] = ["databaseDbId", "databaseUserId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if database_user_id (nullable) is None
        # and model_fields_set contains the field
        if self.database_user_id is None and "database_user_id" in self.model_fields_set:
            _dict['databaseUserId'] = None
