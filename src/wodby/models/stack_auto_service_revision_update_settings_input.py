...
class StackAutoServiceRevisionUpdateSettingsInput(BaseModel):
    """
    StackAutoServiceRevisionUpdateSettingsInput
    """ # noqa: E501
    enabled: StrictBool
    policy: Optional[StackAutoUpdatePolicyInput] = None
    __properties: ClassVar[List[str]] = ["enabled", "policy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policy": StackAutoUpdatePolicyInput.from_dict(obj["policy"]) if obj.get("policy") is not None else None
        })
        return _obj
