...
class ServiceSettings(BaseModel):
    ...
    auto_base_revision_update: Optional[ServiceAutoBaseRevisionUpdateSettings] = Field(default=None, alias="autoBaseRevisionUpdate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "autoBaseRevisionUpdate": ServiceAutoBaseRevisionUpdateSettings.from_dict(obj["autoBaseRevisionUpdate"]) if obj.get("autoBaseRevisionUpdate") is not None else None
        })
        return _obj
