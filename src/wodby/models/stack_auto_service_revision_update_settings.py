...
class StackAutoServiceRevisionUpdateSettings(BaseModel):
    """
    StackAutoServiceRevisionUpdateSettings
    """ # noqa: E501
    enabled: StrictBool
    policy: Optional[StackAutoUpdatePolicy] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policy": StackAutoUpdatePolicy.from_dict(obj["policy"]) if obj.get("policy") is not None else None
        })
        return _obj
