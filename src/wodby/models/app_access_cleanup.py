...
class AppAccessCleanup(BaseModel):
    """
    AppAccessCleanup
    """ # noqa: E501
    id: StrictInt
    app_access_id: StrictInt = Field(alias="appAccessId")
    ...
    __properties: ClassVar[List[str]] = ["id", "appAccessId", "appInstanceId", "integrationId", "provider", "status", "attempts", "lastError", "createdAt", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "appAccessId": obj.get("appAccessId"),
