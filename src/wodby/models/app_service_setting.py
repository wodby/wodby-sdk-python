...
class AppServiceSetting(BaseModel):
    """
    AppServiceSetting
    """ # noqa: E501
    id: StrictInt
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if from_setting_id (nullable) is None
        # and model_fields_set contains the field
        if self.from_setting_id is None and "from_setting_id" in self.model_fields_set:
            _dict['fromSettingId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "build": obj.get("build"),
            "fromSettingId": obj.get("fromSettingId")
        })
        return _obj
