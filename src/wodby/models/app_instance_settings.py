...
class AppInstanceSettings(BaseModel):
    """
    AppInstanceSettings
    """ # noqa: E501
    auto_stack_upgrade: Optional[AppInstanceAutoStackUpgradeSettings] = Field(default=None, alias="autoStackUpgrade")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "autoStackUpgrade": AppInstanceAutoStackUpgradeSettings.from_dict(obj["autoStackUpgrade"]) if obj.get("autoStackUpgrade") is not None else None
        })
        return _obj
