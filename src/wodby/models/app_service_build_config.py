...
class AppServiceBuildConfig(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if dockerignore (nullable) is None
        # and model_fields_set contains the field
        if self.dockerignore is None and "dockerignore" in self.model_fields_set:
            _dict['dockerignore'] = None
