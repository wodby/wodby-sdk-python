...
class ClusterInfraAppUpgradeChangelog(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["appInstanceId", "appName", "appTitle", "previousStackVersion", "stackVersion", "previousStackRevNumber", "stackRevNumber", "serviceChanges"]
