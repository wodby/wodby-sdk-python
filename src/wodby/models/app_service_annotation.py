...
class AppServiceAnnotation(BaseModel):
    """
    ...
    source: Optional[AppServiceAnnotationSource] = None
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "appServiceId", "name", "value", "envType", "source", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source": AppServiceAnnotationSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
