...
class BackupApi(object):
    ...
    def create_backup(self, data, **kwargs):  # noqa: E501
        """Create manual backup  # noqa: E501

        Create a manual instance backup  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_backup(data, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param RequestBackupCreate data:  (required)
        :return: ResponseTask
        ...
        if kwargs.get('async_req'):
            return self.create_backup_with_http_info(data, **kwargs)  # noqa: E501
        else:
            (data) = self.create_backup_with_http_info(data, **kwargs)  # noqa: E501
            return data

    def create_backup_with_http_info(self, data, **kwargs):  # noqa: E501
        """Create manual backup  # noqa: E501

        Create a manual instance backup  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_backup_with_http_info(data, async_req=True)
        >>> result = thread.get()
        ...
        if ('data' not in params or
                params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `create_backup`")  # noqa: E501
