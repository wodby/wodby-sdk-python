...
class StackApi(object):
    ...
    def update_stack_from_upstream(self, id, **kwargs):  # noqa: E501
    ...
    def update_stack_from_upstream_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update official stack from upstream  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_stack_from_upstream" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_stack_from_upstream`")  # noqa: E501
    ...
    def update_stacks_from_upstream(self, data, **kwargs):  # noqa: E501
    ...
    def update_stacks_from_upstream_with_http_info(self, data, **kwargs):  # noqa: E501
        """Update official stacks from upstream  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_stacks_from_upstream" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('data' not in params or
                params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `update_stacks_from_upstream`")  # noqa: E501
