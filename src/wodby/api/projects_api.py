...
class ProjectsApi:
    ...
    def projects_by_name_name_get(
        ...
        _param = self._projects_by_name_name_get_serialize(
            name=name,
            org_id=org_id,
    ...
    @validate_call
    def projects_by_name_name_get_with_http_info(
        self,
        name: StrictStr,
        org_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    def projects_by_name_name_get_without_preload_content(
        self,
        name: StrictStr,
        org_id: StrictInt,
        _request_timeout: Union[
    ...
    def _projects_by_name_name_get_serialize(
        self,
        name,
        org_id,
        _request_auth,
