...
class ClustersApi:
    ...
    @validate_call
    def get_cluster_infra_app_upgrade_changelog(
        self,
        id: StrictInt,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[ClusterInfraAppUpgradeChangelog]:
        ...
        _param = self._get_cluster_infra_app_upgrade_changelog_serialize(
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ClusterInfraAppUpgradeChangelog]",
            '4XX': "ProblemDetails",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_cluster_infra_app_upgrade_changelog_with_http_info(
        self,
        id: StrictInt,
        app_instance_id: Optional[StrictInt] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ClusterInfraAppUpgradeChangelog]]:
        """Preview cluster infrastructure app upgrades
    ...
    @validate_call
    def get_cluster_infra_app_upgrade_changelog_without_preload_content(
        self,
        id: StrictInt,
        app_instance_id: Optional[StrictInt] = None,
        _request_timeout: Union[
    ...
    def _get_cluster_infra_app_upgrade_changelog_serialize(
        self,
        id,
        app_instance_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/cluster-infra-app-upgrade-changelogs/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_kubernetes_version_upgrade_plan(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_kubernetes_version_upgrade_plan_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "KubernetesVersionUpgradePlan",
            '4XX': "ProblemDetails",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_kubernetes_version_upgrade_plan_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[KubernetesVersionUpgradePlan]:
        """Get Kubernetes version upgrade plan
    ...
    @validate_call
    def get_kubernetes_version_upgrade_plan_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_kubernetes_version_upgrade_plan_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/cluster-kubernetes-version-upgrade-plans/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def update_cluster_environment_policy(
        self,
        id: StrictInt,
        cluster_environment_policy_input: ClusterEnvironmentPolicyInput,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param cluster_environment_policy_input: (required)
        :type cluster_environment_policy_input: ClusterEnvironmentPolicyInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_cluster_environment_policy_serialize(
            id=id,
            cluster_environment_policy_input=cluster_environment_policy_input,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_cluster_environment_policy_with_http_info(
        self,
        id: StrictInt,
        cluster_environment_policy_input: ClusterEnvironmentPolicyInput,
        _request_timeout: Union[
    ...
    @validate_call
    def update_cluster_environment_policy_without_preload_content(
        self,
        id: StrictInt,
        cluster_environment_policy_input: ClusterEnvironmentPolicyInput,
        _request_timeout: Union[
    ...
    def _update_cluster_environment_policy_serialize(
        self,
        id,
        cluster_environment_policy_input,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if cluster_environment_policy_input is not None:
            _body_params = cluster_environment_policy_input
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/clusters/environment-policy/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_cluster_settings(
        self,
        id: StrictInt,
        cluster_settings_input: ClusterSettingsInput,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param cluster_settings_input: (required)
        :type cluster_settings_input: ClusterSettingsInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_cluster_settings_serialize(
            id=id,
            cluster_settings_input=cluster_settings_input,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_cluster_settings_with_http_info(
        self,
        id: StrictInt,
        cluster_settings_input: ClusterSettingsInput,
        _request_timeout: Union[
    ...
    @validate_call
    def update_cluster_settings_without_preload_content(
        self,
        id: StrictInt,
        cluster_settings_input: ClusterSettingsInput,
        _request_timeout: Union[
    ...
    def _update_cluster_settings_serialize(
        self,
        id,
        cluster_settings_input,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if cluster_settings_input is not None:
            _body_params = cluster_settings_input
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/clusters/settings/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def upgrade_cluster_infra(
        ...
        _param = self._upgrade_cluster_infra_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def upgrade_cluster_infra_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def upgrade_cluster_infra_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _upgrade_cluster_infra_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/clusters/{id}/actions/upgrade-infra',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def upgrade_cluster_infra_apps(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _param = self._upgrade_cluster_infra_apps_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def upgrade_cluster_infra_apps_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def upgrade_cluster_infra_apps_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _upgrade_cluster_infra_apps_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/clusters/{id}/actions/upgrade-infra-apps',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
