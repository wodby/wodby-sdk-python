...
class ClustersApi:
    ...
    def get_cluster_metrics(
        ...
        _param = self._get_cluster_metrics_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_cluster_metrics_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_cluster_metrics_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_cluster_metrics_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/clusters/metrics/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_cluster_metrics(
        self,
        ids: Annotated[List[StrictInt], Field(min_length=1, description="Comma-separated cluster ids")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ids: Comma-separated cluster ids (required)
        :type ids: List[int]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_cluster_metrics_serialize(
            ids=ids,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_cluster_metrics_with_http_info(
        self,
        ids: Annotated[List[StrictInt], Field(min_length=1, description="Comma-separated cluster ids")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ClusterMetrics]]:
        """Get metrics for multiple clusters
    ...
    @validate_call
    def list_cluster_metrics_without_preload_content(
        self,
        ids: Annotated[List[StrictInt], Field(min_length=1, description="Comma-separated cluster ids")],
        _request_timeout: Union[
            None,
    ...
    def _list_cluster_metrics_serialize(
        self,
        ids,
        _request_auth,
        _content_type,
