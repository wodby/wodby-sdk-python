...
class OrgMembershipsApi:
    ...
    def get_org_membership(
        ...
        _param = self._get_org_membership_serialize(
            id=id,
    ...
    @validate_call
    def get_org_membership_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_org_membership_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_org_membership_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org-memberships/{id}',
    ...
    @validate_call
    def list_org_memberships_with_http_info(
        self,
        org_id: Annotated[Optional[StrictInt], Field(description="Optional for API-key requests; defaults to the API key's organization. If provided, it must match the key's organization.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_org_memberships_without_preload_content(
        self,
        org_id: Annotated[Optional[StrictInt], Field(description="Optional for API-key requests; defaults to the API key's organization. If provided, it must match the key's organization.")] = None,
        _request_timeout: Union[
            None,
