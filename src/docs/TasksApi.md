...
with wodby.ApiClient(configuration) as api_client:
    ...
    try:
        # List tasks
        api_response = api_instance.list_tasks(scope=scope, org_id=org_id, project_ids=project_ids, without_origin=without_origin, statuses=statuses, search=search, app_id=app_id, app_instance_id=app_instance_id, stack_id=stack_id, database_id=database_id, cluster_id=cluster_id, service_id=service_id, integration_id=integration_id, provider_id=provider_id, page=page, page_size=page_size)
