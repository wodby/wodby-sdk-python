...
with wodby.ApiClient(configuration) as api_client:
    ...
    view = 'view_example' # str | Return matching tasks as a flat page or as filter-scoped task trees. Tree responses support user, organization, project, and resource filters, keep paginated roots in items, and include all current-page tree nodes in treeItems. (optional)
 ...
 **view** | **str**| Return matching tasks as a flat page or as filter-scoped task trees. Tree responses support user, organization, project, and resource filters, keep paginated roots in items, and include all current-page tree nodes in treeItems. | [optional] 
