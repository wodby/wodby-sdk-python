...
[**delete_project**](ProjectsApi.md#delete_project) | **DELETE** /projects/{id} | Delete project
[**get_project**](ProjectsApi.md#get_project) | **GET** /projects/{id} | Get project
[**get_project_by_name**](ProjectsApi.md#get_project_by_name) | **GET** /projects/by-name/{name} | Get project by name
...
# **create_project**
> Project create_project(new_project_input)
...
with wodby.ApiClient(configuration) as api_client:
    ...
    try:
        # Create project
        api_response = api_instance.create_project(new_project_input)
...
# **delete_project**
> OperationResult delete_project(id)
...
with wodby.ApiClient(configuration) as api_client:
    ...
    try:
        # Get project by name
        api_response = api_instance.get_project_by_name(name, org_id=org_id)
...
# **list_projects**
> List[Project] list_projects(org_id=org_id)
...
with wodby.ApiClient(configuration) as api_client:
    ...
    try:
        # List projects
        api_response = api_instance.list_projects(org_id=org_id)
...
with wodby.ApiClient(configuration) as api_client:
    ...
    try:
        # Update project
        api_response = api_instance.update_project(id, update_project_input)
