...
[**get_cluster_metrics**](ClustersApi.md#get_cluster_metrics) | **GET** /clusters/metrics/{id} | Get cluster metrics
[**list_cluster_metrics**](ClustersApi.md#list_cluster_metrics) | **GET** /cluster-metrics | Get metrics for multiple clusters
...
# **get_cluster_metrics**
> ClusterMetrics get_cluster_metrics(id)
...
with wodby.ApiClient(configuration) as api_client:
    ...
    try:
        # Get cluster metrics
        api_response = api_instance.get_cluster_metrics(id)
        print("The response of ClustersApi->get_cluster_metrics:\n")
        pprint(api_response)
    except Exception as e:
...
# **list_cluster_metrics**
> List[ClusterMetrics] list_cluster_metrics(ids)
...
with wodby.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = wodby.ClustersApi(api_client)
    ids = [56] # List[int] | Comma-separated cluster ids

    try:
        # Get metrics for multiple clusters
        api_response = api_instance.list_cluster_metrics(ids)
        print("The response of ClustersApi->list_cluster_metrics:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ClustersApi->list_cluster_metrics: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ids** | [**List[int]**](int.md)| Comma-separated cluster ids | 

### Return type

[**List[ClusterMetrics]**](ClusterMetrics.md)
...
with wodby.ApiClient(configuration) as api_client:
    ...
    try:
        # List clusters
        api_response = api_instance.list_clusters(org_id=org_id, project_ids=project_ids, integration_id=integration_id)
