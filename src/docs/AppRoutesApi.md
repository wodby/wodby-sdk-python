...
# **retry_app_route_certificate**
> OperationResult retry_app_route_certificate(id)
...
with wodby.ApiClient(configuration) as api_client:
    ...
    try:
        # Retry app route certificate
        api_response = api_instance.retry_app_route_certificate(id)
        print("The response of AppRoutesApi->retry_app_route_certificate:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AppRoutesApi->retry_app_route_certificate: %s\n" % e)
```
