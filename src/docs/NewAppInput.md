...
**environment_name** | **str** | Required for the canonical app environment contract. | [optional] 
**environment_title** | **str** | Defaults to environmentName when omitted. | [optional] 
**environment_type** | **str** | Required for the canonical app environment contract. | [optional] 
**instance_name** | **str** | Legacy alternative to environmentName. Requires envId and cannot be combined with canonical app environment fields. | [optional] 
**instance_title** | **str** | Legacy alternative to environmentTitle. Defaults to instanceName when omitted. | [optional] 
**domain** | **str** | Defaults to environmentName.name.orgDomain for the canonical contract, or instanceName.name.orgDomain for the legacy contract. | [optional] 
