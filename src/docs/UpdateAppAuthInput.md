...
------------ | ------------- | ------------- | -------------
**app_service_ids** | **List[int]** | App services to protect. Omit every scope field to preserve the current scope, or pass an empty list to protect the whole app instance. | [optional] 
